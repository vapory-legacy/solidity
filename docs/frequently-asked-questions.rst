...
there should be a `test contract <https://github.com/vaporyco/solidity/blob/develop/test/libsolidity/SolidityEndToEndTest.cpp>`_ for every single feature of Solidity.
...
Store Vapor in a contract
=========================

The trick is to create the contract with ``{from:someaddress, value: web3.toWei(3,"vapor")...}``
