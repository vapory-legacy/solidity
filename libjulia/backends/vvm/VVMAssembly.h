...
class VVMAssembly: public AbstractAssembly
{
public:
	explicit VVMAssembly(bool _vvm15 = false): m_vvm15(_vvm15) { }
	virtual ~VVMAssembly() {}
...
private:
	...
	bool m_vvm15 = false; ///< if true, switch to vvm1.5 mode
