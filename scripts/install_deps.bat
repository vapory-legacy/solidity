...
REM
REM See https://github.com/vaporyco/cpp-dependencies
REM
...
REM     https://github.com/vaporyco/webthree-umbrella/issues/345
REM
REM     See "Windows - Try to use NuGet C++ packages"
REM     https://github.com/vaporyco/webthree-umbrella/issues/509
REM
REM     See "CM - Can we switch to NuGet delivery for our external dependencies"
REM     https://github.com/vaporyco/webthree-umbrella/issues/376
REM
...
REM already done just that for LLVM within vvmjit.  The downside of
